...
# -------------------------
    ...
    with tab1:
        ...
        with st.expander('##### ✍ 追加', expanded=True):
            ...
            - 現在、サンプルとして飛騨市公式観光サイト「[飛騨の旅](https://www.hida-kankou.jp/)」の各種データを追加してあります。データをまとめたCSVファイルは[GitHub](https://github.com/imu3da/my_research/tree/main/my_research/output)に置いてあります。これらのファイルから、知識削除後の再追加も可能です。
            ''')
        # 削除する知識の指定
